...
// bad solution because computation takes so long
...
// Transform array
const transformArray = (wirepathString, transformToArray) => {
    let wirePathArray = transformToArray(wirepathString);
    let wirePathArrayTransformed = []
    
    // Position 3 of the coordinate is for measurement of distance 
...
// getToalDistances until an intersection is reached
const totalDistanceIntersections = (wirePathString1, wirePathString2, transformArray) => {
    ...
    for (let e of wirePathArrayTransformed1) {
        for (let f of wirePathArrayTransformed2) {
            if(e[0] === f[0] && e[1] === f[1]) {
                totalDistances.push(e[2] + f[2])
            }        
        }
    }
...
const getShortestDistance = (wirePathString1, wirePathString2, totalDistanceIntersections) => {
    const totalDistances = totalDistanceIntersections(wirePathString1, wirePathString2, transformArray)
    const shortestDistance = Math.min(...totalDistances)
    return shortestDistance
}


// Solution
const shortestDistance = getShortestDistance(wirePathString1, wirePathString2, totalDistanceIntersections)
console.log("Solution Task 2:", shortestDistance) 


//Testing
const wirePathTest1_1 = "R8,U5,L5,D3"
const wirePathTest1_2 = "U7,R6,D4,L4"
console.log("Test 1:", getShortestDistance(wirePathTest1_1, wirePathTest1_2, totalDistanceIntersections) === 30)

const wirePathTest2_1 = "R75,D30,R83,U83,L12,D49,R71,U7,L72"
const wirePathTest2_2 = "U62,R66,U55,R34,D71,R55,D58,R83"
console.log("Test 2:", getShortestDistance(wirePathTest2_1, wirePathTest2_2, totalDistanceIntersections) === 610)
...
console.log("Test 3:", getShortestDistance(wirePathTest3_1, wirePathTest3_2, totalDistanceIntersections) === 410)
